...
class CompanyCultureAgent(BaseAgent):
    ...
    async def _analyze_company_culture(
        ...
        positive_documents = await self.retrieve_knowledge(
            query=f"{company_name} 사내문화 조직문화 회사분위기 좋음 분위기 좋은 직원들 사이 좋음 동료관계 화목 팀워크 좋음 소통 원활 수평적 문화 개방적 분위기 자유로운 의견개진 창의적 업무환경 혁신적 문화 도전정신 격려 실수 용인 학습문화 성장지향 다양성 존중 포용적 문화 공정한 평가 투명한 경영 신뢰문화 존중문화 협력적 분위기 즐거운 업무환경 재미있는 직장 활기찬 분위기 긍정적 에너지 친근한 상사 배려하는 동료 서로 도움 상호존중 편안한 분위기 스트레스 적은 인간적인 회사",
        ...
        negative_documents = await self.retrieve_knowledge(
            query=f"{company_name} 사내문화 조직문화 회사분위기 나쁨 분위기 안좋음 직원들 사이 나쁨 동료관계 갈등 팀워크 안됨 소통 부족 수직적 문화 폐쇄적 분위기 경직된 문화 보수적 분위기 권위적 문화 갑질 문화 괴롭힘 따돌림 차별 편파적 평가 불투명한 경영 불신문화 경쟁적 분위기 스트레스 많은 업무환경 삭막한 직장 무기력한 분위기 부정적 에너지 까다로운 상사 이기적인 동료 도움 안줌 상호불신 경직된 분위기 스트레스 많은 인간관계 복잡 정치적 회사문화 파벌 인맥 중시",
            collections=self.target_collections,
            company_name=company_name,
