...
class SalaryBenefitsAgent(BaseAgent):
    ...
    async def _analyze_salary_benefits(
        ...
        positive_documents = await self.retrieve_knowledge(
            query=f"{company_name} 연봉 급여 월급 임금 소득 높음 좋음 만족 보너스 인센티브 성과급 스톡옵션 주식매수선택권 퇴직금 복리후생 복지 혜택 건강보험 4대보험 의료비 지원 건강검진 종합검진 식비 지원 점심 제공 간식 제공 카페테리아 통근버스 교통비 지원 차량 지원 기숙사 사택 주거지원 대출 지원 학자금 지원 자녀 학비 지원 육아휴직 출산휴가 임신출산 지원 동호회 지원 휴양시설 리조트 콘도 지원 경조사비 지원 선물 지급 문화생활 지원 도서구입비 휴가비 지원 재택근무 지원금 노트북 지급 장비 지원",
        ...
        negative_documents = await self.retrieve_knowledge(
            query=f"{company_name} 연봉 급여 월급 임금 소득 낮음 적음 부족 불만족 아쉬움 보너스 없음 인센티브 적음 성과급 적음 스톡옵션 없음 주식매수선택권 없음 퇴직금 적음 복리후생 부족 복지 미흡 혜택 적음 건강보험 부실 의료비 지원 부족 건강검진 부실 식비 지원 없음 점심 개인부담 간식 없음 카페테리아 없음 통근버스 없음 교통비 지원 없음 차량 지원 없음 기숙사 없음 사택 없음 주거지원 없음 대출 지원 없음 학자금 지원 없음 자녀 학비 지원 없음 육아휴직 사용 어려움 출산휴가 눈치 경조사비 지원 없음 휴양시설 없음 문화생활 지원 없음 재택근무 지원금 없음 장비 지원 부족",
            collections=self.target_collections,
            company_name=company_name,
